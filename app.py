...
from config import JWT_SECRET_key,JWT_ACCESS_TOKEN_EXPIRE,JWT_RESFRESH_TOKEN_EXPIRE
...
# importing auth blueprint from auth_routes.py
app.register_blueprint(auth_bp)

# importing student blueprint from students_routes.py
...
# JWT CONFIGURATION CONNECT
app.config["JWT_SECRET_KEY"]=JWT_SECRET_key
app.config["JWT_ACCESS_TOKEN_EXPIRE"]=JWT_ACCESS_TOKEN_EXPIRE
app.config["JWT_REFRESH_TOKEN_EXPIRE"]=JWT_RESFRESH_TOKEN_EXPIRE
jwt = JWTManager(app)
